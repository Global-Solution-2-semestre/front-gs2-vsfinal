      ...
      <main className="max-w-4xl mx-auto px-6 pt-24 pb-12">
        <Card variant="glow" className="mb-8">
          <div className="flex flex-col items-center gap-6 text-center">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center text-6xl animate-breathe">
              👤
            </div>
        ...
        <Card>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm text-gray-600 dark:text-gray-400">ID de Usuário</label>
              <p className="text-lg font-semibold text-gray-900 dark:text-gray-50">
                #{usuario.id}
              </p>
            </div>
